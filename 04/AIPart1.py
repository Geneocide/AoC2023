...
# Things of use though. 1 is the map() function for getting numbers into arrays. 2 is the ** for scoring. 3 is the idea of removing winning numbers. could save time, although it could have messed things up if a card could have won twince. It was not specified.
