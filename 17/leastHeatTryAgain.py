...
def dijkstra(start):
    ...
    while queue:
        ...
        for moveDirection in directions:
            ...
            if newStraightCount > 3:  # can't go straight more than 3
                continue
            if heading == getOppositeDirection(
                moveDirection
...
print(
    "Minimum heat loss: " + str(min(scores[xMax - 1, yMax - 1].values()))
)  # answer 907
# getPathFromScores(xMax - 1, yMax - 1)
